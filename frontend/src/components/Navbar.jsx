...
export default function Navbar() {
  ...
  return (
    ...
    {user && nation && resources.length > 0 && (
      <div style={{ background: 'var(--surface)', padding: '4px 16px', display: 'flex', gap: 16, overflowX: 'auto', flexWrap: 'nowrap' }}>
        ...
        {countdown && (
          <div style={{ marginLeft: 'auto', display: 'flex', gap: 4, alignItems: 'baseline', whiteSpace: 'nowrap', fontSize: 12 }}>
